<%-- 
    Document   : Header
    Created on : 6/05/2024, 11:36:22 p. m.
    Author     : Josue Jessid
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="AdministradorInterfaz.jsp">PQRS</a>
        ...
        <div class="offcanvas offcanvas-start" style="width: 250px;" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
            <div class="offcanvas-header text-center mb-5">
                <h5 class="container offcanvas-title text-center" id="offcanvasWithBothOptionsLabel">Menú de Opciones</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <!-- Opciones dentro del menú lateral -->
            <div class="offcanvas-body py-3">
                <div class="container mb-4 mt-4">
                    <a class="nav-link" href="UsuariosRegistrados.jsp">
